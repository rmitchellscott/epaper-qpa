...
constexpr static EpaperEvdevKeyboardMap::Mapping keymap[] = {
    ...
    { KEY_MINUS, 0x002b, Qt::Key_Plus, Modifiers::ModPlain, 0x00, 0x0000 },
    ...
    { KEY_SEMICOLON, 0x00e6, Qt::Key_AE, Modifiers::ModPlain, Flags::IsLetter, 0x0000 },
    { KEY_SEMICOLON, 0x00c6, Qt::Key_AE, Modifiers::ModShift, Flags::IsLetter, 0x0000 },

    // KEY_APOSTROPHE (40)
    // "ø" Latin Small Letter O with Stroke 0x00f8
    // "Ø" Latin Capital Letter O with Stroke 0x00d8
    { KEY_APOSTROPHE, 0x00f8, Qt::Key_Ooblique, Modifiers::ModPlain, Flags::IsLetter, 0x0000 },
